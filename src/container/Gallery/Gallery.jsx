  ...
  return (
    <div className="gericht__gallery flex__center">
      <div className="gericht__gallery-content">
        ...
        <p className="p__opensans" style={{ color: '#AAAAAA', marginTop: '2rem' }}>Discover the artistry and joy behind our culinary creations. Browse through our photo gallery capturing vibrant flavors, warm ambiance, and cherished moments shared at our restaurant.</p>
